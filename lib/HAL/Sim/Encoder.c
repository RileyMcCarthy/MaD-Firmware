        ...
        do {
            ...
            if ((bytes_received_a > 0) && (bytes_received_b > 0)) {
                ...
                else
                {
                    ...
                    //    ;
                    // fprintf(__stdoutp, "\x1b[36m"
                    //                   "%0.3f - %s:%d: "
                    //                   "Invalid quad encoder data %d:%d\n"
                    //                   "\x1b[0m",
                    //        _getus() / 1000000.0f, "/Users/rileymccarthy/Documents/MaD-Firmware/src/HAL/Sim/Encoder.c", 39, recv_a[0], recv_b[0]);
                }
            }
