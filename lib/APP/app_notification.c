...
typedef struct
{
    IO_staticQueue notificationQueue;
...
void app_notification_stageRequest()
{
    ...
    {
        if (IO_staticQueue_pop(&app_notification_data.notificationQueue, &notification))
        {
...
void app_notification_init(int lock)
{
    ...
    strcpy(app_notification_data.notificationJSON, "");
    IO_staticQueue_init_lock(&app_notification_data.notificationQueue, app_notification_data.notificationBuffer, APP_NOTIFICATION_BUFFER_SIZE, sizeof(app_notification_message_S), lock);
}
...
void app_notification_send(app_notification_type_E type, const char *format, ...)
{
    ...
    va_end(args);
    IO_staticQueue_push(&app_notification_data.notificationQueue, &notification);
}
