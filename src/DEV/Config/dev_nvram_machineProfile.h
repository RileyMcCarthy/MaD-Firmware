...
#define DEV_NVRAM_MAX_CONFIGURATION_MOTOR_TYPE 20
#define DEV_NVRAM_MAX_CONFIGURATION_ENCODER_TYPE 20
#define DEV_NVRAM_MAX_CONFIGURATION_FORCE_GAUGE 20
#define DEV_NVRAM_MAX_SAMPLE_PROFILE_NAME 45

typedef struct MachineConfiguration
{
    char motorType[DEV_NVRAM_MAX_CONFIGURATION_MOTOR_TYPE];             // Motor used for the machine (model)
    ...
    char positionEncoderType[DEV_NVRAM_MAX_CONFIGURATION_ENCODER_TYPE]; // Encoder used for the position measurement (encoder or distance scale)
    int encoderStepsPermm;                                              // steps per um of position encoder (step/mm)
    int servoStepPermm;                                                 // Steps per mm of servo motor
    char forceGauge[DEV_NVRAM_MAX_CONFIGURATION_FORCE_GAUGE];           // Force gauge used (model)
...
{
    char name[DEV_NVRAM_MAX_SAMPLE_PROFILE_NAME]; // Name of the sample profile
